...
//test to see if the correct amount of health is being subtracted from the Player
...
//test that adds a potion to the inventory
...
// test that uses a potion from inventory
